      ...
      <div>
          <nav class="navbar shadow">
              ...
              <li><a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) === 'MySchedule.php') { echo 'nav-link-active'; } ?>" href="MySchedule.php">My Schedule</a></li>
                  <?php if ($role === "17b1cdac-93f8-4a5f-a5cd-907272094140") { ?><li class="nav-item"><a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) === 'MyAttendance.php') { echo 'nav-link-active'; } ?>" href="MyAttendance.php">My Attendance Record</a></li><?php } ?>
                  <?php if ($role === "ce425e0d-7a9a-4d4f-96c2-333eef8c709d") { ?><li class="nav-item"><a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) === 'StudentAttendance.php') { echo 'nav-link-active'; } ?>" href="StudentAttendance.php">Student Attendance Records</a></li><?php } ?>
                  <?php if ($role === "ce425e0d-7a9a-4d4f-96c2-333eef8c709d") { ?><li class="nav-item"><a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) === 'Events.php') { echo 'nav-link-active'; } ?>" href="Events.php">Events</a></li><?php } ?>
                  <?php if ($role === "ce425e0d-7a9a-4d4f-96c2-333eef8c709d") { ?><li class="nav-item"><a class="nav-link <?php if (basename($_SERVER['PHP_SELF']) === 'Reporting.php') { echo 'nav-link-active'; } ?>" href="Reporting.php">Reporting</a></li><?php } ?>
                  <?php if ($role === "ce425e0d-7a9a-4d4f-96c2-333eef8c709d") { ?><li class="nav-item dropdown-nav">
