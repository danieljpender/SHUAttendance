...
if ($row['Attended'] == 'No') {
  ...
  $body = 'Dear '.$row['FirstName'].PHP_EOL . PHP_EOL .'I just wanted to check with you regarding your attendance record for the session today. Did you face any issues in accessing the event or submitting your attendance record?'.PHP_EOL . PHP_EOL .'Thank you for your cooperation.'.PHP_EOL . PHP_EOL .'Regards,'.PHP_EOL .''.$_SESSION["firstname"].'';
}
  echo '<tr>';
